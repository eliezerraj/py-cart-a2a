        ...
        with tracer.start_as_current_span("agent.receive") as span:
            ...
            try:
                ...
                if envelope.message_type == "CART_PRICE_ANALYSIS":
                    self.msg_type = "CART_PRICE_ANALYSIS_RESULT"
                elif envelope.message_type == "CART_PRICE_CLUSTER_FIT":
                    self.msg_type = "CART_PRICE_CLUSTER_FIT_RESULT"
                elif envelope.message_type == "CART_PRICE_CLUSTER_DATA":
                    self.msg_type = "CART_PRICE_CLUSTER_DATA_RESULT"
                else:
